...
public abstract class AbstractEmailClient implements IEmailClient{
		
	protected EmailSender sender;
	protected EmailReceiver receiver;

	public AbstractEmailClient() {
	...
	@Override
	public abstract void setProvider(EmailProvider provider, String encoding);
