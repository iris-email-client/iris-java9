...
public class IrisFolderComboBoxModel  extends AbstractListModel<Object> implements ComboBoxModel<Object> {
	...
	public IrisFolderComboBoxModel() {
		this.folders = new ArrayList<>();
	}

	public IrisFolderComboBoxModel(List<IrisFolder> folders) {
		this();
